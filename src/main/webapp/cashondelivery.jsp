...
<head>
    <meta charset="UTF-8">
    <title>Eco-Barn | Order Placed - Cash On Delivery</title>
...
<%@ include file="header.jsp" %>
  ...
  <div class="container">
        ...
        <h2 >Order Placing is Successful</h2>
        ...
        <div class="order-details">
            ...
            <p><span class="label">Estimated Delivery:</span> <span class="value-blue"><%= deliveryDate %></span></p>
             Please pay <span class="amount">LKR <c:out value="${FinalAmount}" /></span>
 to the delivery person on arrival.
